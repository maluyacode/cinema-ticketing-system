...
const { create, allCinemas, getSingleCinema, updateCinema, deleteCinema, cinemaWithActiveShows } = require('../controllers/CinemaController');
...
router.get('/with-active-shows/:id', isAuthenticated, cinemaWithActiveShows);
